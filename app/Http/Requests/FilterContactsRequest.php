...
class FilterContactsRequest extends BaseApiRequest
{
    /**
    ...
    {
        return auth()->user()->tokenCan('server:read', Contact::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'contact_type' => ['nullable', 'string', Rule::in(Contact::getContactTypes())],
